...
var ToastDanger = function ToastDanger(title, msg) {
    ToastrActions.Pop(title, msg, _ToastrTypes2.default.danger);
};

var toastrStyle = './styles/react-toastr-basic.css';

var ToastSuccess = function ToastSuccess(title, msg) {
    ToastrActions.Pop(title, msg, _ToastrTypes2.default.success);
};
exports.Toast = Toast;
